...
public class String_1 {
    ...
    public String conCat(String a, String b) {
        ...
        else if (a.substring(a.length()-1).equals(b.substring(0, 1))) return a + b.substring(1);
        else return a+b;
    }
    ...
    public String lastTwo(String str) {
        if (str.length() < 2) return str;
        else return str.substring(0, str.length() - 2) + str.substring(str.length() - 1)
    ...
    public String minCat(String a, String b) {
        boolean a_shorter = a.length() <= b.length();
        int shorter = a_shorter ? a.length() : b.length();
        if (a_shorter) return a + b.substring(b.length()-shorter);
        else return a.substring(a.length()-shorter) + b;
    }
    ...
    public String deFront(String str) {
        ...
        if (len == 0) return mt;
            ...
            if (str.substring(0, 1).equals("a")) keep_first = true;
            if (str.substring(1, 2).equals("b")) keep_second = true;
            if (!keep_first && keep_second) return str.substring(1);
            else if (keep_first && !keep_second) return str.substring(0, 1) + str.substring(2);
            else if (keep_first && keep_second) return str;
    ...
    public String startWord(String str, String word) {
        ...
        boolean match = str.substring(1, word.length()).equals(word.substring(1, word.length()));
    ...
    public String withoutX2(String str) {
        ...
        boolean secX = false;
        if (str.length() > 0 && str.substring(0, 1).equals("x")) firstX = true;
        if (str.length() > 1 && str.substring(1, 2).equals("x")) secX = true;
        if (firstX && secX) return str.substring(2);
        else if (firstX && !secX) return str.substring(1);
        else if (!firstX && secX) return str.substring(0, 1) + str.substring(2);
        else return str;
    }
}
